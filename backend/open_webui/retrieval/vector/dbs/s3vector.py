...
class S3VectorClient(VectorDBBase):
    """
    AWS S3 Vector integration for CryoTensor Knowledge.
    """
    ...
    def _filter_metadata(
        ...
        # Keep only the first 10 keys, prioritizing important ones based on actual CryoTensor metadata
        important_keys = [
    ...
    def get(self, collection_name: str) -> Optional[GetResult]:
        ...
        try:
            ...
            # The CryoTensor GetResult expects lists of lists, so we wrap each list
            if all_ids:
                return GetResult(

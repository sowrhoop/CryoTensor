...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "CryoTensor")
if WEBUI_NAME != "CryoTensor":
    WEBUI_NAME += " (CryoTensor)"

WEBUI_FAVICON_URL = os.environ.get("WEBUI_FAVICON_URL", "/favicon.png")

ENABLE_REMOTE_BRANDING_FETCH = False

ENABLE_REMOTE_LICENSE_FETCH = False
...
OTEL_METRICS_EXPORTER_OTLP_ENDPOINT: str | None = None
OTEL_LOGS_EXPORTER_OTLP_ENDPOINT: str | None = None
OTEL_EXPORTER_OTLP_INSECURE = False
OTEL_METRICS_EXPORTER_OTLP_INSECURE = False
OTEL_LOGS_EXPORTER_OTLP_INSECURE = False
